...
SCHEDORG_URL = "http://flock2014.sched.org/api/"
SCHEDORG_RONLY_API_KEY = "2edfc1db1658a080d22261caf8a6fab4"
OFFLINE_MODE = False
...
def schedule2html(schedule, users, cordova = False, directory = "mobileweb"):
    ...
    render(env, "schedule.html", "%s/schedule20140806.html" % directory, schedule = schedule, users = users, date = "2014-08-06", cordova = cordova)
    render(env, "schedule.html", "%s/schedule20140807.html" % directory, schedule = schedule, users = users, date = "2014-08-07", cordova = cordova)
    render(env, "schedule.html", "%s/schedule20140808.html" % directory, schedule = schedule, users = users, date = "2014-08-08", cordova = cordova)
    render(env, "schedule.html", "%s/schedule20140809.html" % directory, schedule = schedule, users = users, date = "2014-08-09", cordova = cordova)
